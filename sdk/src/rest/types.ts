import type { RequestConfig, RequestOptions, RequestTransformer, ResponseTransformer } from '../types/request.js';
...
export interface RestConfig extends RequestConfig {
